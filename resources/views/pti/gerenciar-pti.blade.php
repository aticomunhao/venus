        ...
        <div class="col-12 mt-3 row">
            <div class="col d-flex justify-content-start mb-3">
                <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#filtros"
                    style="box-shadow: 1px 2px 3px #000000; margin:5px;">
                    Selecionar Grupo <i class="bi bi-funnel"></i>
                </button>

                <a href="/gerenciar-membro/{{ $selected_grupo }}">
                    <input class="btn btn-light btn-sm me-md-2"
                        style="font-size: 0.9rem; box-shadow: 1px 2px 3px #000000; margin:5px;" type="button"
                        value="Gerenciar Grupo">
                </a>
                <!-- Botão para abrir o modal -->
                <a href="/incluir-avulso-pti" class="btn btn-danger btn-sm"
                    style="box-shadow: 1px 2px 3px #000000; margin:5px;">Passe trabalhador</a>
                                    ...
                                    <div class="row col-10">
                                        <div class="col-12">
                                            ...
                                            <input class="form-control" type="text" id="nome_pesquisa"
                                                name="nome_pesquisa" value="{{ request('nome_pesquisa') }}">
                                        </div>
