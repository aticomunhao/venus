        ...
        <div class="row justify-content-center">
            <div class="col-12">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="/gerenciar-pti" type="button" class="btn btn-outline-danger btn-sm float-end">
                ...
                <div class="card-body">
                    ...
                    @endforeach
                     <!-- Garantir que o cabeçalho de faltas apareça mesmo se não houver dados -->
                    ...
                    <a id="btn-back-to-top" href="#" class="btn btn-secondary btn-lg">↑</a>
                            ...
                            <table class="table table-sm table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr style="text-align:center;font-size:13px">
                                        ...
                                        <td>{{ date('d-m-Y', strtotime(current(current($result))->dh_enc)) }}</td>
                        ...
                        <div class="row">
                            <div class="col">
                                <a class="btn btn-danger" href="/gerenciar-pti" style="text-align:right;"
