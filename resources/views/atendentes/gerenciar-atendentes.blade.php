...
@section('title') Gerenciar Atendente Fraterno @endsection
        ...
        <div class="row justify-content-center">
                ...
                <div class="row">
                    ...
                    <div class="col"><br>
                        ...
                        <a href="/gerenciar-atendentes"><input class="btn btn-light btn-sm me-md-2" style="font-size: 0.9rem; box-shadow: 1px 2px 5px #000000; margin:5px;" type="button" value="Limpar"></a>
                    </form>
