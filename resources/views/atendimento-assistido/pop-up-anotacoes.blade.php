    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fs-5" id="">Temática do atendimento</h5>
                ...
                <div class="row" style="text-align: left;">
                    <div class="col">Espirituais                    
                        <div class="form-check">
                            ...
                            <label for="ame" class="form-check-label"></label>
                        </div>
                        <div class="form-check">
                            ...
                            <label for="afe" class="form-check-label"></label>
                        </div>
                        <div class="form-check">
                            ...
                            <label for="diamo" class="form-check-label"></label>
                        </div>
                        <div class="form-check">
                            ...
                            <label for="getrat" class="form-check-label"></label>
                        </div>
                        <div class="form-check">
                            ...
                            <label for="nutres" class="form-check-label"></label>
                        </div>
                    </div>
                    <div class="col">Relacionamentos                    
                        <div class="form-check ">
                            <input type="checkbox" name="ame" data-toggle="toggle" data-size="sm" data-onstyle="success" data-offstyle="danger" data-onlabel="Sim" data-offlabel="Não">
                            <label for="ame" class="form-check-label"></label>
                        </div>
