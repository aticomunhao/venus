    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal mt-4" method="POST" action="/gerar-enc_entre/{{$assistidos->idat}}">
                @csrf
                <div class="row" style="text-align: left;">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label for="inlineCheckbox1" class="form-check-label">Assessoria de Estudos e Aplicação da Medicina Espiritual - AME</label>
                    </div>
                    <div class="form-check form-check-inline">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label for="inlineCheckbox1" class="form-check-label">Divisão de Apoio ao Médium Ostensivo em Eclosão da Mediunidade - DIAMO</label>
                    </div>
                    <div class="form-check form-check-inline">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label for="inlineCheckbox1" class="form-check-label">Núcleo de tratamento Espiritual - NUTRES</label>
                    </div>
                </div>
            </div>                    
                <br>
