...
<div class="container">
    ...
    <div class="card">
        ...
        <br>
        <div class="card-body">
            <form class="form-horizontal mt-2" method="post" action="/visulizar-entrevista/{{ $encaminhamento->id }}">
                @csrf
                ...
                <div class="row mb-5">
                    <div class="col">
                        ...
                        <select class="form-control" id="id_tipo_tratamento" name="id_tipo_tratamento" disabled>
                            @foreach ($informacoes as $informacao)
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="entrevista" name="entrevista" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col">
                        ...
                        <input type="number" class="form-control" id="quantidade_pessoas" name="quantidade_pessoas" disabled>
                    </div>
                    <div class="col">
