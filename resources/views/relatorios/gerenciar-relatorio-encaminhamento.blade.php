        ...
        <table class="table table-sm table-striped table-bordered border-secondary table-hover align-middle"
            ...
            <thead style="text-align:center;">
                <tr style="background-color: #d6e3ff; font-size:14px; color:#000000">
                    ...
                    <th class="col-1" style="min-width: 80px;">DIA</th>
                    <th class="col">ASSISTIDO</th>
                    <th class="col">TRATAMENTO</th>
                    <th class="col-1" style="min-width: 100px;">TEMPO</th>
                    <th class="col-1" style="min-width: 100px;">STATUS</th>
                    <th class="col-1" style="min-width: 120px;">MOTIVO</th>
                </tr>
            </thead>
            ...
            <tbody style="font-size:14px; color:#000000; text-align:center;">
                @foreach ($encaminhamento as $enc)
                    <tr>
                        <td class="d-none">{{ $enc->nome_atendente }}</td>
...
<script>
    $(document).ready(function() {
        ...
        // Apenas para mostrar/esconder a coluna atendente na página atual
        $searchInput.on('keyup', function() {
            ...
            if (showAtendente) {
                ...
                $("#tabelaEnca tbody tr td:first-child").removeClass("d-none");
            } else {
                $colAtendente.addClass("d-none");
                $("#tabelaEnca tbody tr td:first-child").addClass("d-none");
            }
        });
    });
</script>
