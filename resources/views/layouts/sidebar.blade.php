                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                        ...
                        @if (in_array(15, $acesso))
                            <li><a class="dropdown-item" href="/gerenciar-mediunidades">Mediunidades</a></li>
                        @endif
                        @if (in_array(39, $acesso))
                            <li><a class="dropdown-item" href="/gerenciar-passe">Passes</a></li>
                        @endif
                        @if (in_array(30, $acesso))
                            <li><a class="dropdown-item" href="/gerenciar-presenca-dirigente">Presença Trabalhador</a></li>
                        @endif
                        @if (in_array(3, $acesso))
                            <li><a class="dropdown-item" href="/gerenciar-pessoas">Pessoas</a></li>
                        @endif
                        @if (in_array(21, $acesso))
                            <li><a class="dropdown-item" href="/gerenciar-atendentes-plantonistas">Plantonistas</a></li>
                        @endif
                        {{-- @if (in_array(19, $acesso))
                                <li><a class="dropdown-item" href="/gerenciar-reunioes">Gerenciar Reuniões </a></li>
                            @endif --}}
                        @if (in_array(34, $acesso))
                            <li><a class="dropdown-item" href="/gerenciar-relatorio-pessoas-grupo">Relatório de Membros</a></li>
                        @endif
                        @if (in_array(35, $acesso))
                            <li><a class="dropdown-item" href="/gerenciar-relatorio-reuniao">Relatório de Reuniões</a></li>
                        @endif
                        @if (in_array(22, $acesso))
                            <li><a class="dropdown-item" href='/relatorio-vagas-grupos'>Relatório de Vagas em Grupos</a></li>
                        @endif
                    </ul>
                </li>
            </ul>
