            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal mt-4" method="POST" action="/trocar-grupo-tratamento-pti/{{$result[0]->ide}}" >
                        @csrf
                ...
                <div class="row">
                        <div class="d-grid gap-1 col-4 mx-auto">
                            <a class="btn btn-danger" href="/gerenciar-encaminhamentos-pti"  role="button">Cancelar</a>
                        </div>
