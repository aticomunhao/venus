...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-3">Descrição
                            <input class="form-control" type="text" id="nome_pesquisa" name="nome_pesquisa"
                                placeholder="Pesquisar descrição {{ request('descrição') }}">
                        </div>
                        ...
                        <div class="col"><br>
                            <input class="btn btn-light btn-sm me-md-2"
                                ...
                                value="Pesquisar">
                            <a href="/gerenciar-fatos"><input class="btn btn-light btn-sm me-md-2"
                                    style="font-size: 0.9rem; box-shadow: 1px 2px 5px #000000; margin:5px;" type="button"
                                    value="Limpar"></a>
                </form>
                <a href="/criar-fatos"><input class="btn btn-success btn-sm me-md-2" style="font-size: 0.9rem;"
                        type="button" value="Novo Fato +"></a>
                ...
                @foreach ($lista as $listas)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/deletar-fatos" class="btn btn-outline-danger btn-sm tooltips" data-bs-toggle="modal"
                                data-bs-target="#confirmacaoDelecao" onclick="confirmarExclusao('{{ $listas->id }}')">
    ...
    <div class="modal fade" id="confirmacaoDelecao"{{ $listas->id }} tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center; ">
                    Tem certeza que deseja excluir este fato <br /><span
                        style="color:#DC4C64; font-weight: bold;"></span>&#63;
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                    <a type="button" class="btn btn-primary" id="btn-confirmar-exclusao"
                        onclick="confirmarDelecao()">Confirmar </a>
                </div>
            </div>
        </div>
