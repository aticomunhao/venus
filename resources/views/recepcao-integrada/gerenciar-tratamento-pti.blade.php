...
<h4 class="card-title" class="card-title" style="font-size:20px; text-align: left; color: gray; font-family:calibri">GERENCIAR TRATAMENTOS</h4>
    <div class="col-12">
        <div class="row justify-content-center">
            <div>
                <form action="/gerenciar-tratamentos-pti" class="form-horizontal mt-4" method="GET" >
                <div class="row">
                    ...
                    <div class="col-1">Status
                        ...
                        <div class="col"><br/>
                            ...
                            <a href="/gerenciar-tratamentos-pti"><input class="btn btn-light btn-sm me-md-2" style="box-shadow: 1px 2px 5px #000000; margin:5px;" type="button" value="Limpar"></a>
                    </form>
