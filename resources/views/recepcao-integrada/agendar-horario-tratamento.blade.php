                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">Representante
                                    <input class="form-control"
                                        ...
                                        value="{{ $result[0]->nm_2 }}" name="" id="" type="text"
                                        disabled>
                                </div>
                                <div class="col">Tratamento
                                    <input class="form-control"
                                        style="font-weight:bold; background: #f3f3f3; color: rgb(0, 0, 0);"
                                        value="{{ $result[0]->desctrat }}" name="" id="" type="text"
                                        disabled>
                                </div>
                            </div>
                        </fieldset>
                        <div class="row">
                            <div class="col">Dia da semana:
                                <input class="form-control"
                                    style="font-weight:bold; background: #f3f3f3; color: rgb(0, 0, 0);"
                                    value="{{ $trata[0]->nomed }}" name="" id="" type="text" disabled>
                            </div>
                            <form class="form-horizontal mt-4" method="POST"
                                action="/trocar-grupo-tratamento/{{ $result[0]->ide }}">
                                @csrf
                                <legend style="color:#525252; font-size:12px; font-family:sans-serif">Reuniões do dia:
                                </legend>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="{{ $a++ }}">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    aria-expanded="false" aria-controls="flush-collapse{{ $c++ }}">
                                                        ...
                                                        <table class="table table-sm table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                <tr style="text-align:center;font-size:14px">
                                                                    ...
                                                                    <td>{{ $tratas->numero }}</td>
                                                                    <td>{{ $tratas->siglas }}</td>
                                                                    <td>{{ date('H:i:s', strtotime($tratas->h_inicio)) }}
                                                                    </td>
