                    ...
                    <tbody style="font-size: 14px; color:#000000; text-align: center;">
                        ...
                        @foreach($lista as $listas)
                            ...
                            <td>
                                ...
                                <a href="/alterar-grupo-tratamento/{{$listas->idtr}}"><button type="button" class="btn btn-outline-primary btn-sm"  data-tt="tooltip" data-placement="top" title="Alterar Grupo"><i class="bi bi-arrow-left-right" style="font-size: 1rem; color:#000;"></i></button></a>
