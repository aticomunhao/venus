                        ...
                        <table class="table table-sm table-bordered table-striped">
                            ...
                            <tbody>
                                <tr style="text-align:center;font-size:13px">
                                    ...
                                    <td>{{ $encaminhamento->dt_fim != null ? date('d/m/Y', strtotime($encaminhamento->dt_fim)) : '-' }}</td>
                                    ...
                                    <td>
                                        <a class="btn btn-sm tooltips" href="/visualizar-enc/{{ $encaminhamento->ide }}" style="text-align:right;"
                                        role="button">
