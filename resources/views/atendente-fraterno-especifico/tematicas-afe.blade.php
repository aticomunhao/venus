                            ...
                            <div class="row">
                                    ...
                                    <div class="col" style="text-align:center">Espirituais
                                        <div class="form-check m-2">
                                            ...
                                            <label for="maf" class="form-check-label tooltips">1.1<span class="tooltiptext">Mediunidade aflorada</span></label>
                                        </div>
                                        <div class="form-check m-2">
                                            <input id="1" type="checkbox" name="ies" data-size="small"
                                                data-size="small" data-toggle="toggle" data-onstyle="success"
                                                data-offstyle="danger" data-onlabel="Sim" data-offlabel="Não">
                                            <label for="ies" class="form-check-label tooltips">1.2<span class="tooltiptext">Influenciação espiritual</span></label>
                                        </div>
                                        <div class="form-check m-2">
                                            <input id="2" type="checkbox" name="obs" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="obs" class="form-check-label tooltips">1.3<span class="tooltiptext">Obsessão</span></label>
                                        </div>
                                    </div>
                                    <div class="col" style="text-align:center;">Relacionamento
                                        <div class="form-check  m-2">
                                            <input id="5" type="checkbox" name="coj" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="coj" class="form-check-label tooltips">2.1<span class="tooltiptext">Conjugal</span></label>
                                        </div>
                                        <div class="form-check   m-2">
                                            <input id="6" type="checkbox" name="fam" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="fam" class="form-check-label tooltips">2.2<span class="tooltiptext">Familiar</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="7" type="checkbox" name="soc" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="soc" class="form-check-label tooltips">2.3<span class="tooltiptext">Social</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="8" type="checkbox" name="prf" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="prf" class="form-check-label tooltips">2.4<span class="tooltiptext">Profissional</span></label>
                                        </div>
                                    </div>
                                    <div class="col" style="text-align:center;">Físicas/mentais
                                        <div class="form-check  m-2">
                                            <input id="14" type="checkbox" name="sau" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="sau" class="form-check-label tooltips">3.1<span class="tooltiptext">Saúde</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="15" type="checkbox" name="pdg" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="pdg" class="form-check-label tooltips">3.2<span class="tooltiptext">Psiquiátrica diagnosticada</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="16" type="checkbox" name="sex" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="sex" class="form-check-label tooltips">3.3<span class="tooltiptext">Sexualidade</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="17" type="checkbox" name="dts" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="dts" class="form-check-label tooltips">4.1<span class="tooltiptext">Desânimo / Tristeza /<br /> Solidão</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="18" type="checkbox" name="adp" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="adp" class="form-check-label tooltips">4.2<span class="tooltiptext">Ansiedade / Depressão</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="19" type="checkbox" name="dqu" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="dqu" class="form-check-label tooltips">4.3<span class="tooltiptext">Dependência química</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="20" type="checkbox" name="est" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="est" class="form-check-label tooltips">4.4<span class="tooltiptext">Estresse</span></label>
                                        </div>
                                    </div>
                                    <div class="col" style="text-align:center;">Comportamentais
                                        <div class="form-check  m-2">
                                            <input id="3" type="checkbox" name="abo" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="abo" class="form-check-label tooltips">5.1<span class="tooltiptext">Aborto</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="4" type="checkbox" name="sui" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="sui" class="form-check-label tooltips">5.2<span class="tooltiptext">Suicídio</span></label>
                                        </div>
                                    </div>
                                    <div class="col" style="text-align:center;">Cotidiano
                                        <div class="form-check  m-2">
                                            <input id="9" type="checkbox" name="dou" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="dou" class="form-check-label tooltips">6.1<span class="tooltiptext">Interesse pela Doutrina</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="10" type="checkbox" name="son" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="son" class="form-check-label tooltips">6.2<span class="tooltiptext">Sonhos</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="11" type="checkbox" name="esp" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="esp" class="form-check-label tooltips">6.3<span class="tooltiptext">Medo de espíritos</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="12" type="checkbox" name="dpr" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="dpr" class="form-check-label tooltips">6.4<span class="tooltiptext">Dificuldades profissionais</span></label>
                                        </div>
                                        <div class="form-check  m-2">
                                            <input id="13" type="checkbox" name="deq" data-size="small"
                                                data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                                data-onlabel="Sim" data-offlabel="Não">
                                            <label for="dpr" class="form-check-label tooltips">6.5<span class="tooltiptext">Desencarne de ente querido</span></label>
                                        </div>
                                    </div>
                            </div>
                        </div>
