                                            ...
                                            <table class="table table-sm table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr style="text-align:center;font-size:11px">
                                                        ...
                                                        <td>
                                                            {{ $analisas->t1 }} {{ $analisas->t2 }} {{ $analisas->t3 }}
                                                            {{ $analisas->t4 }} {{ $analisas->t5 }} {{ $analisas->t6 }}
                                                            {{ $analisas->t7 }} {{ $analisas->t8 }} {{ $analisas->t9 }}
                                                            {{ $analisas->t10 }} {{ $analisas->t11 }}
                                                            {{ $analisas->t12 }} {{ $analisas->t13 }}
                                                            {{ $analisas->t14 }} {{ $analisas->t15 }}
                                                            {{ $analisas->t16 }} {{ $analisas->t17 }}
                                                            {{ $analisas->t18 }} {{ $analisas->t19 }}
                                                        </td>
