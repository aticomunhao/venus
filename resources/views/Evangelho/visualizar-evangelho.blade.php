...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">VISUALIZAR EVANGELHO</div>
            </div>
        </div>
        <div class="card-body">
            <form class="form-horizontal mt-2" method="post" action="/atualizar-evangelho/{{ $encaminhamento->id }}">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="number" class="form-control" id="qtd_adultos" name="qtd_adultos" value="{{ $evangelho->qtd_adultos }}" disabled>
                    </div>
                    <div class="col">
                        <label for="qtd_criancas" class="form-label">Quantidade de crianças</label>
                        <input type="number" class="form-control" id="qtd_criancas" name="qtd_criancas" value="{{ $evangelho->qtd_criancas }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="date" class="form-control" id="data" name="data" value="{{ $evangelho->data }}" disabled>
                    </div>
                    <div class="col">
                        <label for="hora" class="form-label">Hora</label>
                        <input type="time" class="form-control" id="hora" name="hora" value="{{ $evangelho->hora }}" disabled>
                    </div>
                </div>
                <br>
