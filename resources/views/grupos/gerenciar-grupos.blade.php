        ...
        <div class="row justify-content-center">
                    ...
                    <div class="col-3">Nome
                        <input class="form-control" type="text" id="nome_pesquisa" name="nome_pesquisa"
                            placeholder="Pesquisar nome {{ request('nome_pesquisa') }}">
                    </div>
                        ...
                        <select class="form-select select2" name="nome_setor">
                            ...
                            @foreach ($setores as $setor)
                                <option value="{{ $setor->nome }}"
                                    {{ request('nome_setor') == $setor->nome ? 'selected' : '' }}>{{ $setor->nome }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/deletar-grupos" class="btn btn-outline-danger btn-sm tooltips"
                                        data-bs-toggle="modal" data-bs-target="#modal{{ $grupos->id }}">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="text-align: center; ">
                                                    Tem certeza que deseja excluir o grupo<br /><span
                                                        style="color:#DC4C64; font-weight: bold;">{{ $grupos->nome }}</span>&#63;
                                                </div>
                                                <div class="modal-footer mt-3">
                                                    <button type="button" class="btn btn-danger"
                                                        data-bs-dismiss="modal">Cancelar</button>
                                                    <a type="button" class="btn btn-primary"
                                                        href="/deletar-grupos/{{ $grupos->id }}">Confirmar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
