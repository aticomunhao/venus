                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <br>
                                            Tipo grupo
                                            <select class="form-select" aria-label=".form-select-lg example" name="id_tipo_grupo" disabled>
                                        ...
                                        <div class="col">
                                            <br>
                                            Tipo de tratamento
                                            <select class="form-select" aria-label=".form-select-lg example" name="id_tipo_tratamento" disabled>
                                                @foreach ($grupo as $item)
