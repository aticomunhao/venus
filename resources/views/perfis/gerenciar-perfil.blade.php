            ...
            <form action="/gerenciar-perfis" class="form-horizontal mt-4" method="GET">
                <div class="row">
                    ...
                    <div class="col"><br>
                        ...
                        <a href="#"><input class="btn btn-light btn-sm me-md-2" style="font-size: 0.9rem; box-shadow: 1px 2px 5px #000000; margin:5px;" type="button" value="Limpar"></a>
                    </form>
            ...
            <table class="table table-sm table-striped table-bordered border-secondary table-hover align-middle">
                ...
                <tbody style="font-size: 14px; color:#000000; text-align:center;">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" type="button" class="btn btn-outline-warning btn-sm" data-tt="tooltip" data-placement="top" title="Editar">
                                <i class="bi bi-pen" style="font-size: 1rem; color:#000;"></i>
                            </a>
                            <a href="#" type="button" class="btn btn-outline-primary btn-sm" data-tt="tooltip" data-placement="top" title="Visualizar">
                                <i class="bi bi-search" style="font-size: 1rem; color:#000;" data-bs-target="#pessoa"></i>
                            </a>
                            <a href="#" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal"  data-tt="tooltip" data-placement="top" title="Deletar">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: center; ">
                                            Tem certeza que deseja excluir o grupo<br /><span style="color:#DC4C64; font-weight: bold;"></span>&#63;
                                        </div>
