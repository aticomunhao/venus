                            ...
                            <div class="row justify-content-center">
                                <form class="form-horizontal mt-2" method="post" action="/incluir-salas/">
                                    ...
                                    <div class="col-1 text-end offset-11">Status <label for="status_sala"></label>
                                        <input type="checkbox" name="status_sala" style=text-align: right; "status_sala" data-toggle="toggle" data-onlabel="A" data-offlabel="D" data-onstyle="success" data-offstyle="">
                                    </div>
                                    <div class="row">
                                        <div class="col">Nome
                                    ...
                                    <div class="row">
                                        <div class="col">Número
                                            <input type="number" class="form-control" id="numero" name="numero" maxlength="3" required>
                                            <br>
                                        </div>
                                        <div class="col">Localização
                                            <select class="form-select " name="id_localizacao" aria-label=".form-select-lg example">
                                                ...
                                                <div class="col">M² da sala
                                                    <input type="number" class="form-control" id="tamanho_sala" name="tamanho_sala" min ="1" required>
                                                </div>
                                                <br>
                                                <div class="col">Número de lugares
                                                    <input type="number" class="form-control" id="nr_lugares" name="nr_lugares" min ="1" required>
