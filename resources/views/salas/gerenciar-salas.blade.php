...
<div class="container-fluid";>
    <h4 class="card-title" class="card-title" style="font-size:20px; text-align: left; color: gray; font-family:calibri">GERENCIAR SALAS</h4>
        <div class="col-12">
            ...
            <table class="table table-sm table-striped table-bordered border-secondary table-hover align-middle">
                ...
                <tbody style="font-size: 14px; color:#000000; text-align:center;">
                    ...
                    <td>
                            ...
                            <a href="/deletar-salas/{{ $salas->ids }}" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmacaoDelecao" onclick="confirmarExclusao('{{ $salas->ids }}')" data-tt="tooltip" data-placement="top" title="Deletar">
