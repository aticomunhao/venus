                            ...
                            <input type="checkbox" name="status_sala" style="text-align: right;" data-toggle="toggle" data-onlabel="A" data-offlabel="D" data-onstyle="success" data-offstyle="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">Número de lugares
                                        <input type="number" class="form-control" id="nr_lugares" name="nr_lugares"  min="1" max="200"  oninput="javascript: if (this.value.length > 3) this.value = this.value.slice(0, 3);" value={{$salaEditada->nr_lugares}} required=required">
                                    </div>
                                </div>
                            <br>
