   ...
   <div class="container mt-3">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <form autocomplete="on" class="form-horizontal mt-4" method="POST" action="/trocar-inscricao/{{$turma[0]->idi}}">
                    @csrf
                <div class="card">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseModalidade{{ Str::slug($modalidade) }}" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="accordion accordion-flush" id="accordionTratamentos{{ Str::slug($modalidade) }}">
                                                @foreach($gruposPorModalidade->groupBy('id_tratamento') as $idTipoTratamento => $grupoTratamento)
                                                        @php
                                                            ...
                                                            $tratamentoIdSlug = Str::slug($modalidade . '-' . $idTipoTratamento);
                                                        @endphp
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseTratamento{{ $tratamentoIdSlug }}"
                                                            ...
                                                            data-bs-parent="#accordionTratamentos{{ Str::slug($modalidade) }}">
                                                            <div class="accordion-body">
                                                                    ...
                                                                    <table class="table table-sm table-bordered table-striped mb-2">
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="text-align:center; font-size:14px">
                                                                                ...
                                                                                <td>
                                                                                    <center>
                                                                                        <input type="radio" class="form-check" name="curso" value="{{ $linha->idi }}" required>
                                                                                    </center>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                            ...
                                            {{-- Fim do accordion tratamento --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            {{-- Fim do accordion modalidade --}}
                            @endforeach
                        </div>
                    </div>
                </div>
