                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                ...
                                <input type="number" id="" value="{{ $atende[0]->idatd }}" class="form-control"
                                    placeholder="Disabled input" disabled>
                            </div>
                            <div class="col-6">
                                <label for="disabledTextInput" class="form-label">Grupo:</label>
                                <input type="text" id="" value="{{ $atende[0]->nomeg }}"
                        ...
                        <div>
                            <form class="form-horizontal mt-4" method="POST"
                                action="/altera-atendente-dia/{{ $atende[0]->idatd }}">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <label for="disabledTextInput" class="form-label">Nome AFI:</label>
                                        <input type="text" id="" value="{{ $atende[0]->nm_4 }}"
                                        ...
                                        <select class="form-select text-center" id="" name="sala"
                                            ...
                                            @foreach ($sala as $salas)
                                                @if ($salas->numero > $atende[0]->nm_sala and $atende[0]->nm_sala > $i)
                                                    <option value="{{ $atende[0]->id_sala }}" selected>
                                                        {{ $atende[0]->nm_sala }}</option>
                                                @endif
