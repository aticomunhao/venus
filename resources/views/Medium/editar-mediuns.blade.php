                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr style="background-color: #d6e3ff; font-size:14px; color:#000000">
                                                <th scope="col">
                                                    <input type="checkbox" id="toggleAll" onclick="toggleCheckboxes(this)">
                                                </th>
                                            ...
                                            @foreach ($tipo_mediunidade as $tipos)
                                                <tr class="{{ $a % 2 == 0 ? 'table-row-gray' : 'table-row-white' }}">
                                                    <td>
                                                        ...
                                                        ?>
                                                        <input class="form-check-input mediunidade-checkbox" type="checkbox"
                                                            name="mediunidades[]" value="{{ $tipos->id }}"
