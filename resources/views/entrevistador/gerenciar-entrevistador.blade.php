...
@section('title') Gerenciar Entrevistador @endsection
...
<div class="container">
    <h4 class="card-title" style="font-size:20px; text-align: left; color: gray; font-family:calibri">GERENCIAR ENTREVISTADOR</h4>
    <div class="col-12">
        ...
        <div class="col">
            <table class="table table-sm table-striped table-bordered border-secondary table-hover align-middle">
                ...
                <tbody style="font-size: 14px; color:#000000; text-align:center;">
                    ...
                    <tr>
                        <td> {{$entrevistadores->nome}} </td>
                        <td> {{$entrevistadores->cpf}} </td>
                        <td> {{$entrevistadores->nascimento}} </td>
                        <td> {{$entrevistadores->setor}} </td>
                        <td> {{$entrevistadores->status}} </td>
                        <td> {{$entrevistadores->sexo}} </td>
                        <td>
                            <a href="/editar-entrevistador/{{$entrevistador->id}}" type="button" class="btn btn-outline-warning btn-sm" data-tt="tooltip" data-placement="top" title="Editar">
                                <i class="bi bi-pen" style="font-size: 1rem; color:#000;"></i>
                            </a>
                            <a href="/visualizar-entrevistador/{{$entrevistador->id}}" type="button" class="btn btn-outline-primary btn-sm" data-tt="tooltip" data-placement="top" title="Visualizar">
                                <i class="bi bi-search" style="font-size: 1rem; color:#000;" data-bs-target="#pessoa"></i>
                            </a>
                            <a href="/deletar-entrevistador" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmacaoDelecao" onclick="confirmarExclusao('{{ $entrevistador->id }}', '{{ $entrevistador->nome }}')" data-tt="tooltip" data-placement="top" title="Deletar">
