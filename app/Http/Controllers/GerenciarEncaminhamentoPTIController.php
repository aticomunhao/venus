        ...
        return view ('/encaminhamento-pti/gerenciar-encaminhamentos', compact('lista', 'stat', 'contar', 'data_enc', 'assistido', 'situacao', 'now', 'motivo'));
            ...
            public function escolherGrupo($id)
            {
                try {
                    ...
                    return view('encaminhamento-pti/agendar-grupo-tratamento', compact('dia_hoje', 'result', 'contgrseg', 'contgrter', 'contgrqua', 'contgrqui', 'contgrsex', 'contgrsab', 'contgrdom', 'conttratseg', 'conttratter', 'conttratqua', 'conttratqui', 'conttratsex', 'conttratsab', 'conttratdom', 'contcap'));
            ...
            public function escolherHorario(Request $request, $ide)
            {
                try {
                    ...
                    return view('/encaminhamento-pti/agendar-horario-tratamento', compact('result', 'trata', 'dia'));
