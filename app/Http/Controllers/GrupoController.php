...
// Supondo que você tenha um método no seu controlador para retornar a view
    ...
    public function show(string $id)
    {
        ...
        return view('grupos/visualizar-grupos', compact('grupo','tipo_grupo','tipo_tratamento','tipo_status_grupo','tipo_motivo'));
    ...
    public function edit(string $id)
    {
        ...
        return view('grupos/editar-grupos', compact('grupo','tipo_grupo','tipo_tratamento','tipo_status_grupo','tipo_motivo'));
