...
class GerenciarEncaminhamentoIntegralController extends Controller
{
    ...
    public function tratamento(Request $request, $ide)
    {
        try {
            ...
            return view('/encaminhamento-integral/agendar-tratamento', compact('result', 'trata', 'dia'));
    ...
    public function escolherGrupo($id)
    {
        try {
            ...
            return view('encaminhamento-integral/agendar-grupo-tratamento', compact('dia_hoje', 'result', 'contgrseg', 'contgrter', 'contgrqua', 'contgrqui', 'contgrsex', 'contgrsab', 'contgrdom', 'conttratseg', 'conttratter', 'conttratqua', 'conttratqui', 'conttratsex', 'conttratsab', 'conttratdom', 'contcap'));
    ...
    public function escolherHorario(Request $request, $ide)
    {
        try {
            ...
            return view('/encaminhamento-integral/agendar-horario-tratamento', compact('result', 'trata', 'dia'));
